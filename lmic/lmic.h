...
enum { TXCONF_ATTEMPTS    =   5 };   //!< Transmit attempts for confirmed frames
...
enum _ev_t { EV_SCAN_TIMEOUT=1, EV_BEACON_FOUND,
             EV_BEACON_MISSED, EV_BEACON_TRACKED, EV_JOINING, //5
...
void LMIC_shutdownRADIO (void); //added by Lobaro
void  LMIC_init         (void);
